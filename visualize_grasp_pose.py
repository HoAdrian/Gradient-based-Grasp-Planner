...
if __name__=="__main__":
    ...
    parser.add_argument('--stress_net_model_path', type=str, default="/home/shinghei/Downloads/shinghei_stuff/all_6polygon_open_gripper/epoch_193", help='path to stress net weights') #(1)
